...
class SpikeLastRowLayer(Layer):
    ...
    def __init__(self, **kwargs):
        kwargs.pop(str('config'))
        super(SpikeLastRowLayer, self).__init__(**kwargs)

    def call(self, x, **kwargs):
        return x[:, -1, :]

    def build(self, input_shape):
        return super(SpikeLastRowLayer, self).build(input_shape)
...
custom_layers = {'SpikeFlatten': SpikeFlatten,
                 ...
                 'SpikeLastRowLayer': SpikeLastRowLayer}
